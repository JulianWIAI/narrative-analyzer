...
gui.py
------
Flask-based web interface for the Narrative Pattern Analyzer.

Serves an interactive web application on http://localhost:5000 with panels
for story analysis, trope browsing, story comparison, template management,
and JSON file upload.
...
<body>
    ...
    <main>
        <aside class="sidebar">
            ...
            <button class="btn" style="width: 100%; margin-top: 8px;" onclick="refreshStories()">
                🔄 Refresh List
            </button>
        </aside>
